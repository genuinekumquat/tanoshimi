...
if start != -1 and end != -1:
    new_text = text[:start] + full_makeDraggable + "\n\n            " + text[end:]
    
    # remove duplicate window.isDraggingVivian = false; just in case it got stuck
    new_text = new_text.replace('window.isDraggingVivian = false;\n\n                                      window.isDraggingVivian = false;', 'window.isDraggingVivian = false;')
    new_text = new_text.replace('window.isDraggingVivian = false;\n  \n                          window.isDraggingVivian = false;', 'window.isDraggingVivian = false;')
