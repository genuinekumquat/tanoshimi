...
public class PostController {
    ...
    public String detail(@PathVariable Long id, @AuthenticationPrincipal CustomUserDetails principal, Model model) {
        PostEntity post = postService.getWithUser(id);
        UserEntity viewer = currentUserOrNull(principal);
        ...
        model.addAttribute("comments", postService.visibleComments(post, viewer));
    ...
    private UserEntity currentUserOrNull(CustomUserDetails principal) {
    ...
    public ApiResponse<List<Map<String, Object>>> getComments(@PathVariable Long id, @AuthenticationPrincipal CustomUserDetails principal) {
        ...
        List<PostCommentEntity> comments = postService.visibleComments(post, currentUserOrNull(principal));
